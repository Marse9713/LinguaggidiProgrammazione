...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_12_ = 12,                       /* '{'  */
  YYSYMBOL_13_ = 13,                       /* '}'  */
  YYSYMBOL_FINECOM = 14,                   /* FINECOM  */
  YYSYMBOL_YYACCEPT = 15,                  /* $accept  */
  YYSYMBOL_input = 16,                     /* input  */
  YYSYMBOL_blocks = 17,                    /* blocks  */
...
static const char *const yytname[] =
{
  ...
  "FINECOM", "$accept", "input", "blocks", "statement", "com", "elsE",
  "rval", "lval", YY_NULLPTR
};
...
#line 1131 "5.tab.c"
  ...
  case 4: /* blocks: statement  */
#line 68 "5.y"
                                                        {(yyval.tp) = makeTree("BLOCK", (yyvsp[0].tp), NULL, NULL, NULL, NULL, NULL);}
#line 1137 "5.tab.c"
    break;

  case 5: /* blocks: statement blocks  */
#line 69 "5.y"
                                                                {(yyval.tp) = makeTree("BLOCK", (yyvsp[-1].tp), (yyvsp[0].tp), NULL, NULL, NULL, NULL);}
#line 1143 "5.tab.c"
    break;

  case 6: /* statement: com  */
#line 72 "5.y"
                                                                                {(yyval.tp) = makeTree("STAT", (yyvsp[0].tp), NULL, NULL, NULL, NULL, NULL);}
#line 1149 "5.tab.c"
    break;

  case 7: /* statement: '{' blocks '}'  */
#line 73 "5.y"
                                                                                {(yyval.tp) = makeTree("STAT", makeTree((yyvsp[-2].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-1].tp), makeTree((yyvsp[0].txt), NULL, NULL, NULL, NULL, NULL, NULL), NULL, NULL, NULL);}
#line 1155 "5.tab.c"
    break;

  case 8: /* com: lval ASSEGN rval FINECOM  */
#line 76 "5.y"
                                                                {(yyval.tp) = makeTree("COM", (yyvsp[-3].tp), makeTree((yyvsp[-2].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-1].tp), makeTree((yyvsp[0].txt), NULL, NULL, NULL, NULL, NULL, NULL), NULL, NULL);}
#line 1161 "5.tab.c"
    break;

  case 9: /* com: lval INCREM rval FINECOM  */
#line 77 "5.y"
                                                                        {(yyval.tp) = makeTree("COM", (yyvsp[-3].tp), makeTree((yyvsp[-2].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-1].tp), makeTree((yyvsp[0].txt), NULL, NULL, NULL, NULL, NULL, NULL), NULL, NULL);}
#line 1167 "5.tab.c"
    break;

  case 10: /* com: WHILE '(' lval ')' statement  */
#line 78 "5.y"
                                                                {(yyval.tp) = makeTree("COM", makeTree((yyvsp[-4].txt), NULL, NULL, NULL, NULL, NULL, NULL), makeTree((yyvsp[-3].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-2].tp), makeTree((yyvsp[-1].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[0].tp), NULL);}
#line 1173 "5.tab.c"
    break;

  case 11: /* com: IF '(' lval ')' statement  */
#line 79 "5.y"
                                                        {(yyval.tp) = makeTree("COM", makeTree((yyvsp[-4].txt), NULL, NULL, NULL, NULL, NULL, NULL), makeTree((yyvsp[-3].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-2].tp), makeTree((yyvsp[-1].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[0].tp), NULL);}
#line 1179 "5.tab.c"
    break;

  case 12: /* com: IF '(' lval ')' statement elsE  */
#line 80 "5.y"
                                                                {(yyval.tp) = makeTree("COM", makeTree((yyvsp[-5].txt), NULL, NULL, NULL, NULL, NULL, NULL), makeTree((yyvsp[-4].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-3].tp), makeTree((yyvsp[-2].txt), NULL, NULL, NULL, NULL, NULL, NULL), (yyvsp[-1].tp), (yyvsp[0].tp));}
#line 1185 "5.tab.c"
    break;

  case 13: /* elsE: ELSE statement  */
#line 83 "5.y"
